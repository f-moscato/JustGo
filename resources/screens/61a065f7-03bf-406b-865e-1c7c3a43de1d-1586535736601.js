jQuery("#simulation")
  .on("click", ".s-61a065f7-03bf-406b-865e-1c7c3a43de1d .click", function(event, data) {
    ...
    if(jFirer.is("#s-Black-cover")) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/a0182407-d570-4054-9cc3-f0a1efcd8279"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-link_intrattenimento")) {
      cases = [
        {
          "blocks": [
            {
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/e39fe98d-d4ab-4089-808f-6f0a9460fae5"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/7f704729-14ee-4fa1-8522-717208aa255d"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-link_cultura")) {
      cases = [
        {
          "blocks": [
            {
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/48d15b0f-d099-4fb4-96a0-ca5fe8b6d91d"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
  ...
  .on("pageload", ".s-61a065f7-03bf-406b-865e-1c7c3a43de1d .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
