jQuery("#simulation")
  .on("click", ".s-30a35191-71a4-4398-a04d-f0263a8bb678 .click", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-Two-line-item_35")) {
      cases = [
        {
          "blocks": [
            {
  ...
  .on("pageload", ".s-30a35191-71a4-4398-a04d-f0263a8bb678 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
